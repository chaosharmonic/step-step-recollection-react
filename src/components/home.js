    ...
    <Content size='small'>
      ...
      <ul>
        ...
        <li>
          ...
          or to the albums menu to navigate songs by the game in which they appear.
        </li>
        <li>
          To add a song to your gameplay session, select "add to setlist,"
          then choose from the options displayed
        </li>
        <li>
          Navigate to the setlist menu to update or save your current setlist.
          You can also view existing setlists here, as well as edit or delete yours.
        </li>
      </ul>
      <p>
